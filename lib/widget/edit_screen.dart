...
import 'package:flutter_application_1/widget/edit_item.dart';
...
class _EditAccountScreenState extends State<EditAccountScreen> {
  String gender = "man"; // Set default gender to "man"
                ...
                widget: Row(
                  children: [
                    IconButton(
                      ...
                      style: IconButton.styleFrom(
                        backgroundColor:
                            gender == "man" ? Colors.blueAccent : Colors.grey.shade200,
                    ...
                    IconButton(
                      ...
                      style: IconButton.styleFrom(
                        backgroundColor:
                            gender == "woman" ? Colors.pinkAccent : Colors.grey.shade200,
                        fixedSize: const Size(50, 50),
                      ),
                      icon: Icon(
                        Ionicons.female,
